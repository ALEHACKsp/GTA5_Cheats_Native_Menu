...
void menu_beep(int snd)
{
	switch (snd)
	{
		case NAV_SELECT: AUDIO::PLAY_SOUND_FRONTEND(-1, (char*)"SELECT", (char*)"HUD_FREEMODE_SOUNDSET", 1);
		case NAV_CANCEL: AUDIO::PLAY_SOUND_FRONTEND(-1, (char*)"CANCEL", (char*)"HUD_FREEMODE_SOUNDSET", 1);
		case NAV_UP_DOWN: AUDIO::PLAY_SOUND_FRONTEND(-1, (char*)"NAV_UP_DOWN", (char*)"HUD_FREEMODE_SOUNDSET", 1);
		case NAV_LEFT_RIGHT: AUDIO::PLAY_SOUND_FRONTEND(-1, (char*)"NAV_LEFT_RIGHT", (char*)"HUD_FREEMODE_SOUNDSET", 1);
		default: break;
	}
}
